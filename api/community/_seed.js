...
// retags in the admin. Pins were placed from memory of the address, not by
// the geocoder; "save and look the pin up again" in the admin re-places any
// that look off. Entries without a fixed venue (a meetup that moves around,
// a network, a house) have no pin on purpose, not because one is missing.
//
...
const IN_PAGE_ORDER = [
  ...
  { id: 'seed-newspeak-house', name: 'Newspeak House', area: 'Bethnal Green',
    tags: ['community', 'tech', 'talk'], note: '', url: '', when: '',
    lat: 51.5245, lng: -0.0721 },
  { id: 'seed-viktor-wynd', name: 'The Viktor Wynd Museum of Curiosities', area: 'Hackney',
    tags: ['curiosities', 'art'], note: '', url: '', when: '',
  ...
  { id: 'seed-institute-of-making', name: 'Institute of Making (UCL)', area: 'Bloomsbury',
    tags: ['making', 'science', 'workshop'], note: '', url: '', when: '',
  ...
  { id: 'seed-escaping-flatland', name: 'Escaping Flatland — London meetups', area: '',
    tags: ['philosophy', 'community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-death-cafe', name: 'Death Cafe', area: '',
    tags: ['talk', 'community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-the-moth', name: 'The Moth', area: '',
    tags: ['storytelling'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-feeling-of-computing', name: 'Feeling of Computing', area: '',
    tags: ['tech', 'community'], note: '', url: 'https://feelingof.com/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-london-permacomputing', name: 'London Permacomputing', area: '',
    tags: ['tech', 'community'], note: '', url: 'https://london.permacomputing.net/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-dorkbot-london', name: 'Dorkbot London', area: '',
    tags: ['tech', 'art'], note: '', url: 'https://dorkbotlondon.org/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-second-renaissance', name: 'Second Renaissance', area: '',
  ...
  { id: 'seed-independent-science-society', name: 'Independent Science Society', area: '',
    tags: ['science', 'community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  ...
  { id: 'seed-sonderhaus', name: 'Sonderhaus', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-morphhouse', name: 'Morphhouse', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-ensemble-rodeo', name: 'Ensemble.Rodeo', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-damsel-collective', name: 'Damsel Collective', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-nourished-communities', name: 'Nourished Communities', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-kairos', name: 'Kairos', area: '',
    tags: ['community'], note: '', url: 'https://www.kairos.london/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-termite-works', name: 'Termite Works', area: '',
    tags: ['community'], note: '', url: 'https://www.termite.works/', when: '',
    lat: null, lng: null, needsCoords: true },
  ...
  { id: 'seed-night-cafe', name: 'Night Cafe', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-archetype-cafe', name: 'Archetype Cafe', area: '',
    tags: ['community'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-space-talk-bar', name: 'Space Talk Bar', area: '',
    tags: ['talk'], note: '', url: '', when: '',
    lat: null, lng: null, needsCoords: true },
