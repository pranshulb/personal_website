...
//
// Every entry is a place (somewhere with a door) or a community (a group, a
// night, a thing that happens); a community with a regular home names it in
// `venue` and is pinned there. The map draws places as solid dots and
// communities as rings.
//
...
const IN_PAGE_ORDER = [
  // ---- places with a door ----
  { id: 'seed-newspeak-house', kind: 'place', name: 'Newspeak House', area: 'Bethnal Green',
    tags: ['community', 'tech', 'talk'], note: '', url: 'https://newspeak.house/', when: '',
    lat: 51.5252, lng: -0.0714 },
  { id: 'seed-viktor-wynd', kind: 'place', name: 'The Viktor Wynd Museum of Curiosities', area: 'Hackney',
    tags: ['curiosities', 'art'], note: '', url: 'https://thelasttuesdaysociety.org/museum/', when: '',
    lat: 51.5335, lng: -0.0588 },
  { id: 'seed-london-centre-for-book-arts', kind: 'place', name: 'London Centre for Book Arts', area: 'Hackney Wick',
    tags: ['making', 'books', 'workshop'], note: '', url: 'https://londonbookarts.org/', when: '',
    lat: 51.5389, lng: -0.0227 },
  { id: 'seed-libreria', kind: 'place', name: 'Libreria', area: 'Spitalfields',
    tags: ['books'], note: '', url: 'https://libreria.io/', when: '',
    lat: 51.5203, lng: -0.0706 },
  { id: 'seed-damsel-collective', kind: 'place', name: 'Damsel Collective', area: 'Shoreditch',
    tags: ['community', 'food'], note: '', url: 'https://www.damselcollective.com/', when: '',
    lat: 51.5296, lng: -0.0772 },
  { id: 'seed-st-katharine', kind: 'place', name: 'Royal Foundation of St Katharine', area: 'Limehouse',
    tags: ['community', 'talk'], note: '', url: 'https://www.rfsk.org.uk/events', when: '',
    lat: 51.5117, lng: -0.0372 },
  { id: 'seed-morocco-bound', kind: 'place', name: 'Morocco Bound Bookshop', area: 'Bermondsey',
    tags: ['books'], note: '', url: 'https://www.moroccobound.co.uk/', when: '',
    lat: 51.5008, lng: -0.0811 },
  { id: 'seed-reference-point', kind: 'place', name: 'Reference Point', area: 'Strand',
    tags: ['books', 'talk'], note: '', url: 'https://www.reference-point.uk/', when: '',
    lat: 51.5122, lng: -0.1150 },
  { id: 'seed-poetry-cafe', kind: 'place', name: 'The Poetry Café (Stanzas)', area: 'Covent Garden',
    tags: ['poetry'], note: '', url: 'https://poetrysociety.org.uk/membership/poetry-society-stanzas/', when: '',
    lat: 51.5151, lng: -0.1236 },
  { id: 'seed-space-talk', kind: 'place', name: 'Space Talk', area: 'Farringdon',
    tags: ['music'], note: '', url: 'https://www.spacetalklondon.com/', when: '',
    lat: 51.5196, lng: -0.1016 },
  { id: 'seed-novelty-automation', kind: 'place', name: 'Novelty Automation', area: 'Holborn',
    tags: ['curiosities', 'making'], note: '', url: 'https://www.novelty-automation.com/', when: '',
    lat: 51.5188, lng: -0.1163 },
  { id: 'seed-conway-hall', kind: 'place', name: 'Conway Hall', area: 'Holborn',
    tags: ['talk', 'community'], note: '', url: 'https://www.conwayhall.org.uk/whats-on/', when: '',
    lat: 51.5199, lng: -0.1185 },
  { id: 'seed-skoob', kind: 'place', name: 'Skoob Books', area: 'Bloomsbury',
    tags: ['books'], note: '', url: 'https://skoob.com/', when: '',
    lat: 51.5244, lng: -0.1232 },
  { id: 'seed-aa-bookshop', kind: 'place', name: 'AA Bookshop', area: 'Bloomsbury',
    tags: ['books', 'art'], note: '', url: 'https://bookshop.aaschool.ac.uk/', when: '',
    lat: 51.5192, lng: -0.1301 },
  { id: 'seed-institute-of-making', kind: 'place', name: 'Institute of Making (UCL)', area: 'Bloomsbury',
    tags: ['making', 'science', 'workshop'], note: '', url: 'https://www.instituteofmaking.org.uk/', when: '',
    lat: 51.5241, lng: -0.1333 },
  { id: 'seed-london-night-cafe', kind: 'place', name: 'London Night Cafe', area: 'Spitalfields',
    tags: ['community', 'curiosities'], note: '', url: 'https://www.londonnightcafe.co.uk/', when: '',
    lat: 51.5160, lng: -0.0759 },
  { id: 'seed-archetype-coffee', kind: 'place', name: 'Archetype Coffee', area: 'Fitzrovia',
    tags: ['food'], note: '', url: 'https://www.instagram.com/archetypecoffee/', when: '',
    lat: 51.5184, lng: -0.1401 },
  { id: 'seed-housmans', kind: 'place', name: 'Housmans book groups', area: "King's Cross",
    tags: ['books', 'community'], note: '', url: 'https://housmans.com/book-groups/', when: '',
    lat: 51.5313, lng: -0.1213 },
  { id: 'seed-word-on-the-water', kind: 'place', name: 'Word On The Water', area: "King's Cross",
    tags: ['books'], note: '', url: 'https://www.wordonthewater.co.uk/', when: '',
    lat: 51.5356, lng: -0.1247 },
  { id: 'seed-nourished-communities', kind: 'place', name: 'Nourished Communities', area: 'Highbury',
    tags: ['food', 'community'], note: '', url: 'https://www.nourishedcommunities.com/', when: '',
    lat: 51.5602, lng: -0.1013 },
  { id: 'seed-roundhouse', kind: 'place', name: 'Roundhouse', area: 'Camden',
  ...
  { id: 'seed-feeling-of-computing', kind: 'community', venue: 'Newspeak House', name: 'Feeling of Computing', area: 'Bethnal Green',
    tags: ['tech', 'community'], note: '', url: 'https://feelingof.com/london/', when: '',
    lat: 51.5252, lng: -0.0714 },
  { id: 'seed-second-renaissance', kind: 'community', venue: 'Newspeak House', name: 'Second Renaissance', area: 'Bethnal Green',
    tags: ['philosophy', 'community'], note: '', url: 'https://secondrenaissance.net/', when: '',
    lat: 51.5252, lng: -0.0714 },
  { id: 'seed-the-moth', kind: 'community', venue: 'Rich Mix', name: 'The Moth', area: 'Shoreditch',
    tags: ['storytelling'], note: '', url: 'https://themoth.org/events/results?eventLocations=67', when: '',
    lat: 51.5242, lng: -0.0738 },
  { id: 'seed-dorkbot-london', kind: 'community', venue: 'Limehouse Town Hall', name: 'Dorkbot London', area: 'Limehouse',
    tags: ['tech', 'art'], note: '', url: 'https://dorkbotlondon.org/', when: '',
    lat: 51.5119, lng: -0.0343 },
  { id: 'seed-london-permacomputing', kind: 'community', venue: 'SET Social', name: 'London Permacomputing', area: 'Peckham',
  ...
  { id: 'seed-offline-club', kind: 'community', name: 'The Offline Club', area: '',
  ...
  { id: 'seed-philosofriends', kind: 'community', name: 'Philosofriends', area: '',
    tags: ['philosophy', 'talk'], note: '', url: 'https://luma.com/philosofriends', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-escaping-flatland', kind: 'community', name: 'Escaping Flatland — London meetups', area: '',
    tags: ['philosophy', 'community'], note: '', url: 'https://www.henrikkarlsson.xyz/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-death-cafe', kind: 'community', name: 'Death Cafe', area: '',
    tags: ['talk', 'community'], note: '', url: 'https://deathcafe.com/search/?location=London', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-independent-science-society', kind: 'community', name: 'Independent Science Society', area: '',
    tags: ['science', 'community'], note: '', url: 'https://www.independentscience.org/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-institute17', kind: 'community', name: 'Institute17', area: '',
    tags: ['philosophy', 'community'], note: '', url: 'https://www.institute17.com/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-sonderhaus', kind: 'community', name: 'Sonderhaus', area: '',
    tags: ['community'], note: '', url: 'https://www.eventbrite.co.uk/o/sonderhaus-77930329263', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-ensemble-rodeo', kind: 'community', name: 'Ensemble.Rodeo', area: '',
    tags: ['making', 'community', 'tech'], note: '', url: 'https://ensemble.rodeo/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-kairos', kind: 'community', name: 'Kairos', area: '',
    tags: ['community', 'talk'], note: '', url: 'https://www.kairos.london/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-termite-works', kind: 'community', name: 'Termite Works', area: '',
    tags: ['making', 'tech'], note: '', url: 'https://www.termite.works/', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-430-on-the-go', kind: 'community', name: '430 On the Go', area: 'Canning Town',
    tags: ['community', 'art'], note: '', url: 'https://radar.squat.net/en/london/430-go', when: '',
    lat: null, lng: null, needsCoords: true },
  { id: 'seed-cranberrylemonade', kind: 'community', name: 'Cranberry Lemonade', area: '',
    tags: ['art', 'tech', 'making'], note: '', url: 'https://www.cranberrylemonade.xyz/', when: '',
    lat: null, lng: null, needsCoords: true },

  // ---- living ----
  { id: 'seed-morphhouse', kind: 'community', name: 'Morph House', area: '',
